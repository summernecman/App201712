...
import com.siweisoft.heavycenter.databinding.FragMainOrderDoneBinding;

import java.util.List;

public class DoneUIOpe extends AppUIOpe<FragMainOrderDoneBinding>{


    public DoneUIOpe(Context context) {
        super(context);
        initRecycle();
    }
    ...
    public void LoadListData(List<String> s){
        bind.recycle.setAdapter(new AppsDataBindingAdapter(context, R.layout.item_main_order_begin, BR.item_main_order_done,s));
