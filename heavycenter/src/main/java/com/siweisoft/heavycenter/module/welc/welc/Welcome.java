...
import com.siweisoft.heavycenter.app.HCApp;
...
public class Welcome extends AppAct<WelcUIOpe,WelcDAOpe> {
    ...
    private void AutoLogin(){
        if(LocalValue.is自动登录()&& LocalValue.get登录参数()!=null){
            getP().getD().go登录(this,new UINetAdapter<LoginResBean>(Welcome.this) {
                @Override
                public void onResult(boolean success, String msg, LoginResBean o) {
                    ...
                    if(success){
                        ...
                        IntentUtil.startActivityWithFinish(Welcome.this, AcctAct.class,null);
                    }
                }
            });
        }else{
