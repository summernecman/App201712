...
public class MyceFrag extends AppFrag<MyceUIOpe,MyceDAOpe>  implements  TakePhoto.TakeResultListener,InvokeListener {
    ...
    public void takeSuccess(TResult result) {
        LogUtil.E(result.getImage().getCompressPath());
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        PermissionManager.handlePermissionsResult(getBaseUIActivity(),type,invokeParam,this);
    }
