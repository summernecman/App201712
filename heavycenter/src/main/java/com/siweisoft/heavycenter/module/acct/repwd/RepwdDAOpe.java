...
public class RepwdDAOpe extends AppDAOpe {
    ...
    public void updatePwd(Context context,ForGetReqBean reqBean, NetI<ForGetResBean> adapter){
        NetDataOpe.updatePwd(context, NetValue.获取地址("/user/forgetPwd"),reqBean,adapter);
    }
