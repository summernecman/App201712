...
public class CommentOpe extends BaseDAOpe implements CommentI {
    ...
    @Override
    public void getOtherCommentByUserIdWithLimit(UserBean userBean, final OnFinishListener onFinishListener) {
        BaseReqBean baseReqBean = new BaseReqBean();
        baseReqBean.setData(GsonUtil.getInstance().toJson(userBean));
    ...
    @Override
    public void getVideoCommentByVideoIdAndCommentId(VideoBean videoBean, final OnFinishListener onFinishListener) {
        BaseReqBean baseReqBean = new BaseReqBean();
        baseReqBean.setData(GsonUtil.getInstance().toJson(videoBean));
