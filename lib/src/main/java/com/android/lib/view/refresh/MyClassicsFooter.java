package com.android.lib.view.refresh;
...
public class MyClassicsFooter extends RelativeLayout implements RefreshFooter {
    ...
    protected int mPaddingTop = 5;
    protected int mPaddingBottom = 5;
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (getPaddingTop() == 0) {
            if (getPaddingBottom() == 0) {
                setPadding(getPaddingLeft(), mPaddingTop = density.dip2px(mPaddingTop), getPaddingRight(), mPaddingBottom = density.dip2px(mPaddingBottom));
            } else {
                setPadding(getPaddingLeft(), mPaddingTop = density.dip2px(mPaddingTop), getPaddingRight(), mPaddingBottom = getPaddingBottom());
            }
        } else {
            if (getPaddingBottom() == 0) {
                setPadding(getPaddingLeft(), mPaddingTop = getPaddingTop(), getPaddingRight(), mPaddingBottom = density.dip2px(mPaddingBottom));
            } else {
